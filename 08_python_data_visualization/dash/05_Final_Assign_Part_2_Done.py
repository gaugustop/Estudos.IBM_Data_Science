...
# dropdown_style = {'width': 80, 'padding': '3px', 'font-size': '20px', 'text-align':'center'}
app.layout = html.Div([
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        # use groupby to create relevant data for 
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(figure = px.bar(unemployment_rec,
                                             x = 'unemployment_rate',
                                             y = 'Automobile_Sales',
                                             color = 'Vehicle_Type',
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure = px.line(msale,
                                              x = 'Month',
                                              y = 'Automobile_Sales',
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart-item', children=[html.Div(children=Y_chart1),html.Div(children=Y_chart2)],style={'text-align':'center'}),
                html.Div(className='chart-item', children=[html.Div(children=Y_chart3),html.Div(children=Y_chart4)],style={'text-align':'center'})
                ]
